...
COLOR_TABLE = {
    ...
    "brightcyan": "96",
    "brightwhite": "97",
    # Extended colors (256-color or TrueColor).
    "orange": "38;5;208",
    "pink": "38;5;213",
    "hotpink": "38;5;205",
    "purple": "38;5;129",
...
def parse_tag(tag: str) -> str:
    """
    Supports tags such as [bold red], [italic #FFAA00], and [color123].
    """
    parts = tag.split(" ")
    seq = ""
    for part in parts:
...
def tag2ansi(text: str) -> str:
    """
    Convert [tag1 tag2] markup to ANSI codes and insert resets automatically.
    Supports multiple color formats, combined styles, and automatic closing.
    """
